...
INDEX_TEMPLATE_ARGUMENTS
INDEXITERATOR_TYPE::IndexIterator(page_id_t page_id, page_id_t index_in_leaf, BufferPoolManager *bpm): page_id_(page_id), index_in_leaf_(index_in_leaf), buffer_pool_manager_(bpm) {}
...
auto INDEXITERATOR_TYPE::operator*() -> const MappingType &{
  ...
  return leaf_page_->PairAt(index_in_leaf_);
}
